...
const MOCK_EXPENSES: ExpenseWithDetails[] = [
  ...
  },
  {
    ...
    group: MOCK_GROUP_CASA, payer: U2,
    splits: [
      { id: "s8", expense_id: "e4", user_id: "u1", amount: 6000, paid_amount: 0, payments: [], profile: U1 },
      { id: "s9", expense_id: "e4", user_id: "u2", amount: 6000, paid_amount: 0, payments: [], profile: U2 },
    ],
  },
  {
    ...
    splits: [
      { id: "s10", expense_id: "e5", user_id: "u1", amount: 11000, paid_amount: 0, payments: [], profile: U1 },
      { id: "s11", expense_id: "e5", user_id: "u2", amount: 11000, paid_amount: 0, payments: [], profile: U2 },
      { id: "s12", expense_id: "e5", user_id: "u3", amount: 10000, paid_amount: 0, payments: [], profile: U3 },
    ],
  },
];
